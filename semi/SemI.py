...
class SemIManager(object):
    ...
    def __init__(self, ontology, cfg):
        '''
        ...
        self.semiManagers = dict.fromkeys(self.ontology.OntologyUtils.available_domains)
    ...
    def _load_domains_semi(self, dstring):
        ...
        if self.cfg.has_option('semi_'+dstring, 'semitype'):
            semi_type = self.cfg.get('semi_'+dstring, 'semitype')
    ...
    def decode(self, ASR_obs, sys_act, domainTag, turn=None):
        ...
        hyps = contextUtils._add_context_to_user_act(sys_act,hyps,self.active_domain, self.ontology)
        return hyps
    ...
    def simulate_add_context_to_user_act(self, sys_act, user_acts, domainTag):
        ...
        hyps = contextUtils._add_context_to_user_act(sys_act,hyps=user_acts,active_domain=self.active_domain, ontology=self.ontology)
