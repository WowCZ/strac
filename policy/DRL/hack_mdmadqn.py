...
class MATransfer(gl.nn.Block):
    def __init__(self, slots, local_in_units, local_units, local_dropout,
                 ...
                 topo_learning_mode=False, message_embedding=False, multidims=4):
        ...
        with self.name_scope():
            ...
            if self.non_local_mode is False:
                ...
                if self.slots_comm:
                    self.f_emit_local2local = gl.nn.Dense(in_units=local_in_units, units=mid_units, use_bias=True)
                self.f_emit_local2global = gl.nn.Dense(in_units=local_in_units, units=mid_units, use_bias=True)
                self.f_emit_global2local = gl.nn.Dense(in_units=global_in_units, units=mid_units, use_bias=True)
                ...
                self.local_atten_act = gl.nn.Dense(in_units=mid_units, units=mid_units, use_bias=False, activation=activation)
                self.local_atten_out = gl.nn.Dense(in_units=mid_units, units=multidims, use_bias=True)
                self.global_atten_act = gl.nn.Dense(in_units=mid_units, units=mid_units, use_bias=False, activation=activation)
                self.global_atten_out = gl.nn.Dense(in_units=mid_units, units=multidims, use_bias=True)
