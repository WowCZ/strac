...
#     
    ...
    def __init__(self, policyManager, committeeMembers, learningmethod, SetObj):
    ...
    def _bayes_committee_calculator(self, domainQs, priors, domainInControl, scale):
        ...
        for act_i in domainQs[domainInControl]:          
            ...
            bcm_samples[act_i] = scale*np.sqrt(bcm_sigma_act_i) * self.SetObj.random.randn() + bcm_mean_act_i  # sample from gaussian            
