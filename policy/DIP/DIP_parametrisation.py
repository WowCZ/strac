...
class DIP_state(State):
    def __init__(self, belief, ontology, domainString=None, action_freq=None):
        #params
        self.domainString = domainString
        self.ontology = ontology
        self.N_bins = 10
        self.slots = list(self.ontology.get_informable_slots(domainString))
    ...
    def convert_general_b(self, belief):
        ...
        val_n = []
        for slot in self.slots:
            val_n.append(len(self.ontology.get_informable_slot_values(self.domainString, slot)))
    ...
    def convert_slot_b(self, belief, slot):
        ...
        V_len = len(self.ontology.get_informable_slot_values(self.domainString, slot))
    ...
    def _get_val_dist_in_DB(self, slot):
        ...
        values = self.ontology.get_informable_slot_values(self.domainString, slot)
        entities = self.ontology.entity_by_features(self.domainString, {})
...
class padded_state(State):
    def __init__(self, belief, domainString=None, action_freq=None):
        ...
        slot_values = self.ontology.get_informable_slots_and_values(domainString)
