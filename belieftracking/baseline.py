...
class RuleBasedTracker(BeliefTracker):
    ...
    def __init__(self,domainString, ontology):
        super(RuleBasedTracker, self).__init__(domainString, ontology)
    ...
    def _tobelief(self, prev_belief, track):
        ...
        for slot in self.ontology.get_informable_slots_and_values(self.domainString):
            if slot in track['goal-labels']:
                infom_slot_vals = self.ontology.get_informable_slot_values(self.domainString,slot)
...
class FocusTracker(RuleBasedTracker):
    ...
    """
    def __init__(self,domainString, ontology):
        super(FocusTracker, self).__init__(domainString, ontology)
        self.restart()
        self.lastInformedVenue = ""
